...
#     },
#     "prompt5": {
#         "text": """For the given image, please assign a perceptual quality score in terms of structure and texture preservation, color and luminance reproduction, noise, contrast, sharpness, and any other low-level distortions. The score must range from 0 to 100, with a higher score denoting better image quality. Your response must only include a score to summarize its visual quality of the given image. The response format should be: Score: [a score].""",
#         "extraction_method": "direct_output"
#     },
#     "prompt6": {
#         "text": """For the given image, please first detail its perceptual quality in terms of structure and texture preservation, color and luminance reproduction, noise, contrast, sharpness, and any other low-level distortions. Then, based on the perceptual analysis of the given image, assign a quality score to the given image. The score must range from 0 to 100, with a higher score denoting better image quality.""",
#         "extraction_method": "direct_output"
#     },
#     "prompt7": {
